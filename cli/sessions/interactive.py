...
async def show_auth_menu() -> str:
    ...
    typer.echo("3. 🧪 Probar Casos de Uso")
    typer.echo("4. ❌ Salir")
    ...
    while True:
        try:
            ...
            if choice == 1:
                ...
                typer.echo("❌ Opción inválida. Selecciona entre 1 y 4.")
        except ValueError:
...
async def show_main_menu(user_profile: UserProfile) -> str:
    ...
    if user_profile.rol in ['HUESPED', 'AMBOS']:
        ...
        options.insert(-3, "⭐ Gestionar reseñas")
        ...
        try:
            ...
            if 1 <= choice <= len(options):
                if "perfil" in options[choice-1]:
                    ...
                    return "reservations"
                elif "Gestionar reseñas" in options[choice-1]:
                    return "reviews"
