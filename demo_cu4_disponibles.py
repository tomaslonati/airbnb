        ...
        if result.get("success"):
            ...
            if propiedades:
                ...
                for i, prop in enumerate(propiedades, 1):
                    ...
                    if i <= 3:
                        print(
                            f"         Nombre: {prop.get('propiedad_nombre', 'N/A')}")
                        print()
                ...
                print(
                    f"   💰 Precio promedio: ${precio_promedio/len(propiedades):.2f}/noche")
                print(
                    f"   👥 Capacidad promedio: {capacidad_total/len(propiedades):.1f} huéspedes")
                print(
                    f"   📶 Con WiFi: {wifi_count}/{len(propiedades)} ({(wifi_count/len(propiedades)*100):.1f}%)")
