...
async def limpiar_duplicados():
    ...
    try:
        ...
        fechas_duplicadas = {fecha: docs for fecha,
                             docs in documentos_por_fecha.items() if len(docs) > 1}
        ...
        for fecha, docs_fecha in fechas_duplicadas.items():
            ...
            print(
                f"   ✅ Consolidado: {len(todas_propiedades)} propiedades, {len(todas_ciudades)} ciudades")
