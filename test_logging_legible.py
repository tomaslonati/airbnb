...
logger.info("🔗 Conectando a PostgreSQL", database="supabase", host="aws-1-sa-east-1.pooler.supabase.com")
...
logger.info("💾 Datos sincronizados", target="Cassandra", collection="reservas_por_ciudad_fecha")
